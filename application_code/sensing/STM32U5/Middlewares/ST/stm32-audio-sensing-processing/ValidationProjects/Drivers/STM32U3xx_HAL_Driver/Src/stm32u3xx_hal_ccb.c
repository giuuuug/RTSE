  ...
  switch (pWrappingKey->WrappingKeyType)
  {
    case HAL_CCB_USER_KEY_WRAPPED:
          ...
          || (Operation == CCB_MODULAR_EXP_CPU_BLOB_CREATION))
      {
        ...
        WRITE_REG(HAL_CCB_GET_SAES_INSTANCE(hccb)->CR, AES_CR_KEYSIZE | AES_CR_CHMOD_0 | AES_CR_CHMOD_1);
      }
    ...
    case HAL_CCB_USER_KEY_HW:
      ...
      {
        /* SAES: GCMPH = 0x0 (initial phase) as event that trig OPSTEP 0x1 --> 0x2 */
        WRITE_REG(HAL_CCB_GET_SAES_INSTANCE(hccb)->CR, AES_CR_KEYSEL_0 | AES_CR_KEYSIZE | AES_CR_CHMOD_0
                  | AES_CR_CHMOD_1);
      }
                                                ...
                                                uint32_t Timeout)
{
  ...
  {
    WRITE_REG(HAL_CCB_GET_SAES_INSTANCE(hccb)->CR, AES_CR_KEYSEL_0 | AES_CR_KMOD_0 | AES_CR_KEYSIZE | AES_CR_CHMOD_0);
  }
  else
  {
