...
#define HAL_HSP_INSTANCE_UNKNOWN  0xFFFFFFFFUL
...
#define HAL_HSP1_CDEGR_ADDRESS     ((volatile uint32_t *)(HSP1_CDEGR_BASE))

#define HAL_HSP_DCMDPTR0_OFFSET  HSP_DCMDPTR0_OFFSET
#define HAL_HSP_DCMDPTR1_OFFSET  HSP_DCMDPTR1_OFFSET
#define HAL_HSP_DCMDPTR2_OFFSET  HSP_DCMDPTR2_OFFSET
#define HAL_HSP_DCMDIDR_OFFSET   HSP_DCMDIDR_OFFSET
#define HAL_HSP_DCMDSR_OFFSET    HSP_DCMDSR_OFFSET
#define HAL_HSP_CDEGR_OFFSET     HSP_CDEGR_OFFSET
...
#define HAL_HSP_ERROR_FIRMWARE          (1UL << 4U)   /*!< Firmware Error: see error code @ref HSP_Firmware_Error_Codes */
...
/**
  * @brief  HAL HSP All Hardware Errors constant
  */
#define HAL_HSP_ERROR_HW_ALL  \
  (HAL_HSP_ERROR_TRGIN_OVR    | HAL_HSP_ERROR_BUFFER_UDR_OR_OVR | HAL_HSP_ERROR_CAPTURE_OVR     \
   | HAL_HSP_ERROR_SCHEDULER  | HAL_HSP_ERROR_HDEG_OVR          | HAL_HSP_ERROR_OPCODE_INVALID  \
   | HAL_HSP_ERROR_SPE_ACCESS | HAL_HSP_ERROR_FPU)
...
/**
  * @brief HAL HSP SmartClocking mask of all blocks
  */
...
/**
  * @brief HAL HSP TRGIN mask of all interfaces
  */
...
/** @defgroup HSP_EVENT_Constants HSP Event Constants
  ...
  */
/**
  * @brief  Event Priority bitfield position in enumerate @ref HAL_HSP_EVENT_SourceTypeDef
  */
#define HAL_HSP_EVENT_PRIO_POS    (26U)

/**
  * @brief  Event Priority bitfield mask in enumerate @ref HAL_HSP_EVENT_SourceTypeDef
  */
#define HAL_HSP_EVENT_PRIO_MSK    (0x1FU << HAL_HSP_EVENT_PRIO_POS)

/**
  * @brief  Event Source bitfield position in enumerate @ref HAL_HSP_EVENT_SourceTypeDef
  */
#define HAL_HSP_EVENT_SOURCE_POS  (0U)

/**
  * @brief  Event Source bitfield mask in enumerate @ref HAL_HSP_EVENT_SourceTypeDef
  */
...
/**
  * @brief  HAL HSP Mask of all HSP Events
  */
...
/**
  * @brief HAL HSP Mask of all STREAM Buffer Errors
  */
...
/**
  * @brief HAL HSP Mask of all TRGIN Errors
  */
#define HAL_HSP_IT_ERR_TRGIN_ALL  (HAL_HSP_IT_ERR_TRGIN_OVR)

/**
  * @brief HAL HSP Mask of all Timestamp Capture Errors
  */
#define HAL_HSP_IT_ERR_TSC_ALL  (HAL_HSP_IT_ERR_TSC_OVR)

/**
  * @brief HAL HSP Mask of all SPE Errors
  */
...
/**
  * @brief HAL HSP Mask of all HSP Errors
  */
...
/**
  * @brief HAL HSP Mask of all HSP SPE Access Errors
  */
...
/**
  * @brief HAL HSP Mask of all HSP FPU Errors
  */
...
#define HAL_HSP_ERRINF_TRGIN0_OVR               HSP_ERRINFR_TRGIERR_0  /*!< Trigger Input 0 Overrun error */
#define HAL_HSP_ERRINF_TRGIN1_OVR               HSP_ERRINFR_TRGIERR_1  /*!< Trigger Input 1 Overrun error */
#define HAL_HSP_ERRINF_TRGIN2_OVR               HSP_ERRINFR_TRGIERR_2  /*!< Trigger Input 2 Overrun error */
#define HAL_HSP_ERRINF_TRGIN3_OVR               HSP_ERRINFR_TRGIERR_3  /*!< Trigger Input 3 Overrun error */
#define HAL_HSP_ERRINF_TRGIN4_OVR               HSP_ERRINFR_TRGIERR_4  /*!< Trigger Input 4 Overrun error */
#define HAL_HSP_ERRINF_TRGIN5_OVR               HSP_ERRINFR_TRGIERR_5  /*!< Trigger Input 5 Overrun error */
#define HAL_HSP_ERRINF_TRGIN6_OVR               HSP_ERRINFR_TRGIERR_6  /*!< Trigger Input 6 Overrun error */
#define HAL_HSP_ERRINF_TRGIN7_OVR               HSP_ERRINFR_TRGIERR_7  /*!< Trigger Input 7 Overrun error */
#define HAL_HSP_ERRINF_TRGIN8_OVR               HSP_ERRINFR_TRGIERR_8  /*!< Trigger Input 8 Overrun error */

/**
  * @brief HAL HSP Mask of all HSP TRGIN Errors
  */
#define HAL_HSP_ERRINF_TRGIN_OVR_ALL  (HAL_HSP_ERRINF_TRGIN0_OVR   | HAL_HSP_ERRINF_TRGIN1_OVR  \
                                       | HAL_HSP_ERRINF_TRGIN2_OVR | HAL_HSP_ERRINF_TRGIN3_OVR  \
                                       | HAL_HSP_ERRINF_TRGIN4_OVR | HAL_HSP_ERRINF_TRGIN5_OVR  \
                                       | HAL_HSP_ERRINF_TRGIN6_OVR | HAL_HSP_ERRINF_TRGIN7_OVR  \
                                       | HAL_HSP_ERRINF_TRGIN8_OVR)
...
/**
  * @brief HAL HSP Mask of all HSP STREAM Buffer Events
  */
...
/**
  * @brief HAL HSP Mask of all HSP TCU Events
  */
#define HAL_HSP_IT_EVT_TCU_ALL  (HAL_HSP_IT_EVT_TCU0_TASK_STARTED   | HAL_HSP_IT_EVT_TCU0_TASK_ENDED  \
                                 | HAL_HSP_IT_EVT_TCU1_TASK_STARTED | HAL_HSP_IT_EVT_TCU1_TASK_ENDED  \
                                 | HAL_HSP_IT_EVT_TCU2_TASK_STARTED | HAL_HSP_IT_EVT_TCU2_TASK_ENDED  \
                                 | HAL_HSP_IT_EVT_TCU3_TASK_STARTED | HAL_HSP_IT_EVT_TCU3_TASK_ENDED  \
                                 | HAL_HSP_IT_EVT_TCU_TASK_OVL)

/**
  * @brief HAL HSP Mask of all HSP SPE Events
  */
...
/**
  * @brief HAL HSP Mask of all HSP Processing Function Events
  */
...
/**
  * @brief HAL HSP Mask of all HSP Processing Function interrupts
  */
...
/** @defgroup HSP_SNOOP_Constants HSP SNOOP Constants
  ...
  */
/**
  * @brief  HAL HSP SNOOP Signal Group position in enumerate @ref HAL_HSP_SNOOP_SignalTypeDef
  */
#define HAL_HSP_SNOOP_SIGNAL_GRP_POS    (27U)

/**
  * @brief  HAL HSP SNOOP Signal Group bitfield mask in enumerate @ref HAL_HSP_SNOOP_SignalTypeDef
  */
#define HAL_HSP_SNOOP_SIGNAL_GRP_MSK    (0x1FU << HAL_HSP_SNOOP_SIGNAL_GRP_POS)

/**
  * @brief  HAL HSP SNOOP Signal Value position in enumerate @ref HAL_HSP_SNOOP_SignalTypeDef
  */
#define HAL_HSP_SNOOP_SIGNAL_VALUE_POS  (0U)

/**
  * @brief  HAL HSP SNOOP Signal Value bitfield mask in enumerate @ref HAL_HSP_SNOOP_SignalTypeDef
  */
#define HAL_HSP_SNOOP_SIGNAL_VALUE_MSK  (0x7U << HAL_HSP_SNOOP_SIGNAL_VALUE_POS)

#define HAL_HSP_SNOOP_SIGNAL_NONE       0UL  /*!< Default value to deactivate SNOOP output */
...
/**
  * @brief HAL HSP BREAK Mask of all Critical Events
  */
...
#define HAL_HSP_BREAK_FREEZE_EVENT_SINGLE_STEP     HSP_BKICFGR_SSEN      /*!< Single Step Event            */

/**
  * @brief HAL HSP BREAK Mask of all Freeze Events
  */
#define HAL_HSP_BREAK_FREEZE_EVENT_ALL                                                    \
  (HAL_HSP_BREAK_FREEZE_EVENT_MEMORY_ACCESS    | HAL_HSP_BREAK_FREEZE_EVENT_FPU           \
   ...
   | HAL_HSP_BREAK_FREEZE_EVENT_SPE_OVR        | HAL_HSP_BREAK_FREEZE_EVENT_SPE_OVR       \
   | HAL_HSP_BREAK_FREEZE_EVENT_FPU_SATURATION | HAL_HSP_BREAK_FREEZE_EVENT_SINGLE_STEP)
...
/**
  * @ Brief Macros to retrieve HSP BRAM definitions
  */
/**
  * @brief Get the HSP BRAMAB Base Address.
  * @param  instance_id  HSP instance (@ref hal_hsp_t).
  * @retval uint32_t.
  */
#define HAL_HSP_GET_BRAMAB_BASE_ADDRESS(instance_id)  \
  (((instance_id) == (uint32_t)HSP1)?HSP1_BRAMAB_BASE: NULL)

/**
  * @brief Get the HSP BRAMAB size in Byte.
  * @param  instance_id  HSP instance (@ref hal_hsp_t).
  * @retval uint32_t.
  */
#define HAL_HSP_GET_BRAMAB_SIZE(instance_id)  \
  (((instance_id) == (uint32_t)HSP1)?HSP1_BRAMAB_SIZE: 0U)

/**
  * @brief Get the HSP BRAMA Base Address.
  * @param  instance_id  HSP instance (@ref hal_hsp_t).
  * @retval uint32_t.
  */
#define HAL_HSP_GET_BRAMA_BASE_ADDRESS(instance_id)  \
  (((instance_id) == (uint32_t)HSP1)?HSP1_BRAMA_BASE: NULL)

/**
  * @brief Get the HSP BRAMB Base Address.
  * @param  instance_id  HSP instance (@ref hal_hsp_t).
  * @retval uint32_t.
  */
#define HAL_HSP_GET_BRAMB_BASE_ADDRESS(instance_id)  \
  (((instance_id) == (uint32_t)HSP1)?HSP1_BRAMB_BASE: NULL)
...
/**
  * @ Brief Macros for direct write access to register (Required only for Direct Access Register & CNN functions)
  */
/**
  * @brief  Write to PARAMRx register of HSP1 instance
  * @param  val  Value of parameter.
  */
#define HAL_HSP1_WRITE_CDEG(val)  (STM32_WRITE_REG(HSP1->CDEGR, val))
...
/** @defgroup HSP_Exported_Types_Group1 HSP Boot Types
  ...
  */
/**
  * @brief HAL HSP Performance Monitor State Definition
  */
typedef enum
{
...
/**
  * @brief HAL HSP Boot Configuration structure
  */
typedef struct
{
...
/** @defgroup HSP_Exported_Types_Group2 HSP Command Enumerations
  ...
  */
/**
  * @brief  HAL HSP Direct Command Parameter ID Definition
  */
typedef enum
{
  HAL_HSP_PARAM_0  = 0U,
...
/** @defgroup HSP_Exported_Types_Group3 HSP Task Comparator Enumerations
  ...
  */
/**
  * @brief  HAL HSP Task Comparator Unit Definition
  */
typedef enum
{
...
/**
  * @brief  HAL HSP Task ID Definition
  */
typedef enum
{
  HAL_HSP_TASK_0 = 0U,
...
/** @defgroup HSP_Exported_Types_Group4 HSP Event Interface Interconnect Matrix Enumerations
  * @{
  */
/**
...
/** @defgroup HSP_Exported_Types_Group5 HSP Stream Interface Types
  ...
  */
/**
  * @brief Enumerate to define the ID of STREAM Interface
  */
typedef enum
{
  HAL_HSP_STREAM_0 = 0UL,
  HAL_HSP_STREAM_1 = 1UL,
  HAL_HSP_STREAM_2 = 2UL,
  HAL_HSP_STREAM_3 = 3UL,
} HAL_HSP_STREAM_BufferTypeDef;

/**
  * @brief Enumerate to define the STREAM Buffer direction
  */
typedef enum
{
  HAL_HSP_STREAM_DIRECTION_CPU_TO_HSP,
  HAL_HSP_STREAM_DIRECTION_HSP_TO_CPU,
} HAL_HSP_STREAM_Buffer_DirectionTypeDef;

/**
  * @brief Enumerate to define the state of Integer to Float conversion feature
  */
typedef enum
{
  HAL_HSP_STREAM_SYNC_DISABLE,
  HAL_HSP_STREAM_SYNC_ENABLE,
...
/**
  * @brief Enumerate to define the state of STREAM block
  */
typedef enum
{
  /** All STREAM Buffers are disabled */
  HAL_HSP_STREAM_DISABLED,

  /** All STREAM Buffers are enabled  */
  HAL_HSP_STREAM_ENABLED,
} HAL_HSP_STREAM_StatusTypeDef;
...
/**
  * @brief Enumerate to define the flag status of STREAM Event
  */
typedef enum
{
...
/** @defgroup HSP_Exported_Types_Group6 HSP Trigger Interface Types
  ...
  */
/**
  * @brief Enumerate to define the Trigger polarity
  */
typedef enum
{
...
/**
  * @brief Enumerate to define the Trigger Interconnect Matrix
  */
typedef enum
{
...
/**
  * @brief Enumerate to define the enabling status of TRGIN instance
  */
typedef enum
{
  /** TRGIN is disabled */
...
/**
  * @brief Enumerate to define the flag status of TRGIN Event or Error
  */
typedef enum
{
...
/**
  * @brief Enumerate to define the Event Synchronization State
  */
typedef enum
{
...
/**
  * @brief Event Synchronization structure
  */
typedef struct
{
...
/**
  * @brief  HSP Polling Mode on End Of Event Status
  */
typedef enum
{
...
/** @defgroup HSP_Exported_Types_Group8  HSP Task Comparator Unit Types
  * @{
  */
/**
  * @brief HAL HSP Task Overlap status
  */
typedef enum
{
...
} HAL_HSP_TCU_TaskOverlap_StatusTypeDef;

/**
  * @brief HAL HSP Task Comparator Unit status
  */
typedef enum
{
...
/** @defgroup HSP_Exported_Types_Group9 HSP Trigger Output Types
  * @{
  */
/**
  * @brief HAL HSP Trigger Output Enumerate
  */
typedef enum
{
...
/**
  * @brief  HAL HSP Trigger Output Source
  */
typedef enum
{
  ...
  HAL_HSP_OUTPUT_TRIGGER_TIMESTAMPCAPTURE = (HSP_TRGOCFGR_TRGO0SRC_0 | HSP_TRGOCFGR_TRGO0SRC_1), /*!< Trigger from TimeStamp Capture */
} HAL_HSP_OUTPUT_TRIGGER_SourceTypeDef;

/**
  * @brief HAL HSP Output status
  */
typedef enum
{
...
/** @defgroup HSP_Exported_Types_Group10  HSP TimeStamp Capture Types
  * @{
  */
/**
  * @brief  HAL HSP TimeStamp Capture Prescaler
  */
typedef enum
{
...
/**
  * @brief  HAL HSP TimeStamp Capture Free Running Counter status
  */
typedef enum
{
...
/**
  * @brief  HAL HSP TimeStamp Capture Task Filter mode
  */
typedef enum
{
...
/**
  * @brief  HAL HSP TimeStamp Capture configuration structure
  */
typedef struct
{
...
/**
  * @brief  HAL HSP TimeStamp Capture status
  */
typedef enum
{
...
/**
  * @brief HAL HSP TimeStamp Data structure
  */
typedef struct
{
...
/** @defgroup HSP_Exported_Types_Group11  HSP BRAM Types
  * @{
  */
/**
  * @brief  HAL HSP BRAM Bandwidth Arbitration enumerate
  */
typedef enum
{
...
/** @defgroup HSP_Exported_Types_Group12  HSP Firmware Types
  * @{
  */
/**
  * @brief HAL HSP Firmware Version structure
 */
typedef struct
{
  ...
  uint32_t minor;
} HAL_HSP_FW_VersionTypeDef;

/**
  * @}
  */

/** @defgroup HSP_Exported_Types_Group13  HSP Common Types
  * @{
  */
/**
  * @brief Enumerate for Direct Command Status
  */
typedef enum
{
...
/**
  * @brief Enumerate for MSGBOX Status
  */
typedef enum
{
...
/** @defgroup HSP_Exported_Types_Group14  HSP SNOOP Types
  * @{
  */
/**
  * @brief HAL HSP SNOOP Group Definition
  */
typedef enum
{
  HAL_HSP_SNOOP_GROUP_A = HSP_SNPR_SNPSELA_Pos,
  HAL_HSP_SNOOP_GROUP_B = HSP_SNPR_SNPSELB_Pos,
} HAL_HSP_SNOOP_GroupTypeDef;

/**
  * @brief HAL HSP SNOOP Signal Definition
  */
typedef enum
{
  HAL_HSP_SNOOP_GRPA_TASK_2_1_0               = ((HSP_SNPR_SNPSELA_Pos << HAL_HSP_SNOOP_SIGNAL_GRP_POS)
                                                 | (HSP_SNPR_SNPSELA_0 << HAL_HSP_SNOOP_SIGNAL_VALUE_POS)),
  HAL_HSP_SNOOP_GRPA_DMA_CH_2_1_0_IT          = ((HSP_SNPR_SNPSELA_Pos << HAL_HSP_SNOOP_SIGNAL_GRP_POS)
                                                 | (HSP_SNPR_SNPSELA_1 << HAL_HSP_SNOOP_SIGNAL_VALUE_POS)),
  HAL_HSP_SNOOP_GRPA_TRGIN_BUFF_ADC           = ((HSP_SNPR_SNPSELA_Pos << HAL_HSP_SNOOP_SIGNAL_GRP_POS)
                                                 | ((HSP_SNPR_SNPSELA_1 | HSP_SNPR_SNPSELA_0)
                                                    << HAL_HSP_SNOOP_SIGNAL_VALUE_POS)),
  HAL_HSP_SNOOP_GRPA_TSC_PFCTNB_2_1_0         = ((HSP_SNPR_SNPSELA_Pos << HAL_HSP_SNOOP_SIGNAL_GRP_POS)
                                                 | (HSP_SNPR_SNPSELA_2 << HAL_HSP_SNOOP_SIGNAL_VALUE_POS)),
  HAL_HSP_SNOOP_GRPA_TSC_CMP_2_1_0            = ((HSP_SNPR_SNPSELA_Pos << HAL_HSP_SNOOP_SIGNAL_GRP_POS)
                                                 | ((HSP_SNPR_SNPSELA_2 | HSP_SNPR_SNPSELA_0)
                                                    << HAL_HSP_SNOOP_SIGNAL_VALUE_POS)),
  HAL_HSP_SNOOP_GRPA_EVTCWKUP_SPEJUMP_SPEWFE  = ((HSP_SNPR_SNPSELA_Pos << HAL_HSP_SNOOP_SIGNAL_GRP_POS)
                                                 | ((HSP_SNPR_SNPSELA_2 | HSP_SNPR_SNPSELA_1)
                                                    << HAL_HSP_SNOOP_SIGNAL_VALUE_POS)),
  HAL_HSP_SNOOP_GRPA_PE_2_1_0                 = ((HSP_SNPR_SNPSELA_Pos << HAL_HSP_SNOOP_SIGNAL_GRP_POS)
                                                 | ((HSP_SNPR_SNPSELA_2 | HSP_SNPR_SNPSELA_1 | HSP_SNPR_SNPSELA_0)
                                                    << HAL_HSP_SNOOP_SIGNAL_VALUE_POS)),

  HAL_HSP_SNOOP_GRPB_TASK_5_4_3               = ((HSP_SNPR_SNPSELB_Pos << HAL_HSP_SNOOP_SIGNAL_GRP_POS)
                                                 | (HSP_SNPR_SNPSELB_0 << HAL_HSP_SNOOP_SIGNAL_VALUE_POS)),
  HAL_HSP_SNOOP_GRPB_PRC_25_24_23             = ((HSP_SNPR_SNPSELB_Pos << HAL_HSP_SNOOP_SIGNAL_GRP_POS)
                                                 | (HSP_SNPR_SNPSELB_1 << HAL_HSP_SNOOP_SIGNAL_VALUE_POS)),
  HAL_HSP_SNOOP_GRPB_DCMD_CDEG_HDEG           = ((HSP_SNPR_SNPSELB_Pos << HAL_HSP_SNOOP_SIGNAL_GRP_POS)
                                                 | ((HSP_SNPR_SNPSELB_1 | HSP_SNPR_SNPSELB_0)
                                                    << HAL_HSP_SNOOP_SIGNAL_VALUE_POS)),
  HAL_HSP_SNOOP_GRPB_TSC_PFCTNB_5_4_3         = ((HSP_SNPR_SNPSELB_Pos << HAL_HSP_SNOOP_SIGNAL_GRP_POS)
                                                 | (HSP_SNPR_SNPSELB_2 << HAL_HSP_SNOOP_SIGNAL_VALUE_POS)),
  HAL_HSP_SNOOP_GRPB_TSC_CMP_3                = ((HSP_SNPR_SNPSELB_Pos << HAL_HSP_SNOOP_SIGNAL_GRP_POS)
                                                 | ((HSP_SNPR_SNPSELB_2 | HSP_SNPR_SNPSELB_0)
                                                    << HAL_HSP_SNOOP_SIGNAL_VALUE_POS)),
  HAL_HSP_SNOOP_GRPB_TSC_PULSE_CALL_IF_IFTRUE = ((HSP_SNPR_SNPSELB_Pos << HAL_HSP_SNOOP_SIGNAL_GRP_POS)
                                                 | ((HSP_SNPR_SNPSELB_2 | HSP_SNPR_SNPSELB_1)
                                                    << HAL_HSP_SNOOP_SIGNAL_VALUE_POS)),
  HAL_HSP_SNOOP_GRPB_PE_5_4_3                 = ((HSP_SNPR_SNPSELB_Pos << HAL_HSP_SNOOP_SIGNAL_GRP_POS)
                                                 | ((HSP_SNPR_SNPSELB_2 | HSP_SNPR_SNPSELB_1 | HSP_SNPR_SNPSELB_0)
                                                    << HAL_HSP_SNOOP_SIGNAL_VALUE_POS)),
} HAL_HSP_SNOOP_SignalTypeDef;

/**
  * @brief HAL HSP BREAK Output Definition
  */
typedef enum
{
...
/**
  * @brief  HAL HSP BREAK Critical Event status
  */
typedef enum
{
...
/**
  * @brief  HAL HSP BREAK Freeze Event status
  */
typedef enum
{
...
/**
  * @}
  */
/** @defgroup HSP_Exported_Types_Group15  HSP Handle
  * @{
  */
/**
...
typedef enum
{
  ...
  HAL_HSP_STATE_READY          = (1UL << 27U),  /*!< HSP initialized, FW & Plugin Loaded and Boot completed  */
  HAL_HSP_STATE_FAULT          = (1UL << 0U)    /*!< HSP Boot uncoverable failure. A HW reset is required    */
} HAL_HSP_StateTypeDef;

/**
  * @brief  HAL HSP Handle Structure definition
  */
typedef struct __HSP_HandleTypeDef
{
  HSP_TypeDef               *Instance;     /*!< Register base address  */
  ...
  __IO uint32_t *cram_address_for_plugin;
  ...
  void(*stream_handler)(struct __HSP_HandleTypeDef *hhsp, uint32_t reg_evt_misr);

  /** HSP subroutine to process Task Comparator Unit Events */
  void(*tcu_handler)(struct __HSP_HandleTypeDef *hhsp, uint32_t reg_evt_misr);

  /** HSP subroutine to process SPE Events */
  void(*spe_handler)(struct __HSP_HandleTypeDef *hhsp, uint32_t reg_evt_misr);

  /** HSP subroutine to process Timestamp Capture Events */
  void(*tsc_handler)(struct __HSP_HandleTypeDef *hhsp, uint32_t reg_evt_misr);

  /** HSP subroutine to process Command Events */
  void(*cmd_handler)(struct __HSP_HandleTypeDef *hhsp, uint32_t reg_evt_misr);

  /** HSP subroutine to process STREAM buffer Errors */
  void(*stream_err_handler)(struct __HSP_HandleTypeDef *hhsp, uint32_t reg_err_misr);

  /** HSP subroutine to process TRGIN Errors */
  void(*trgin_err_handler)(struct __HSP_HandleTypeDef *hhsp, uint32_t reg_err_misr);

  /** HSP subroutine to process Timestamp Capture Errors */
  void(*tsc_err_handler)(struct __HSP_HandleTypeDef *hhsp, uint32_t reg_err_misr);

  /** HSP subroutine to process SPE Errors */
  void(*spe_err_handler)(struct __HSP_HandleTypeDef *hhsp, uint32_t reg_err_misr);

  /** HSP subroutine to process Processing Function Events */
  void(*fwevt_handler)(struct __HSP_HandleTypeDef *hhsp, uint32_t reg_fwevt_misr);

  /* Interrupts callbacks --------------------------------------------------- */
#if (USE_HAL_HSP_REGISTER_CALLBACKS == 1)
  /** HSP SPE Run State callback function pointer */
  void (* EVT_SPE_RunStateCallback)(struct __HSP_HandleTypeDef *hhsp, uint32_t state);

  /** HSP SPE Task Completed callback function pointer */
  void (* EVT_SPE_TaskCpltCallback)(struct __HSP_HandleTypeDef *hhsp);

  /** HSP SPE Direct Command Completed callback function pointer */
  void (* EVT_SPE_DirectCommandCpltCallback)(struct __HSP_HandleTypeDef *hhsp);

  /** HSP SPE FPU Saturation event callback function pointer */
  void (* EVT_SPE_FPUSaturationCallback)(struct __HSP_HandleTypeDef *hhsp);

  /** HSP Timestamp Capture Data Ready callback function pointer */
  void (* EVT_TSC_TimestampReadyCallback)(struct __HSP_HandleTypeDef *hhsp, uint32_t timestamp);

  /** HSP Task Comparator Unit Task Started callback function pointer */
  void (* EVT_TCU_TaskStartedCallback)(struct __HSP_HandleTypeDef *hhsp, uint32_t comparators_mask);

  /** HSP Task Comparator Unit Task Ended callback function pointer */
  void (* EVT_TCU_TaskEndedCallback)(struct __HSP_HandleTypeDef *hhsp, uint32_t comparators_mask);

  /** HSP Task Overlap event callback function pointer */
  void (* EVT_TCU_TaskOverlapCallback)(struct __HSP_HandleTypeDef *hhsp);

  /** HSP STREAM Buffer Empty callback function pointer */
  void (* EVT_STREAM_BufferEmptyCallback)(struct __HSP_HandleTypeDef *hhsp, uint32_t buffers_mask);

  /** HSP STREAM Buffer Full callback function pointer */
  void (* EVT_STREAM_BufferFullCallback)(struct __HSP_HandleTypeDef *hhsp, uint32_t buffers_mask);

  /** HSP Processing Function Event callback function pointer */
  void (* FWEVT_ProcessingEventCallback)(struct __HSP_HandleTypeDef *hhsp, uint32_t events_mask);

  /** HSP Error callback function pointer */
  void (* ErrorCallback)(struct __HSP_HandleTypeDef *hhsp, uint32_t fw_error_code, uint32_t spe_error_inf);

  /** HSP MSP Init callback function pointer */
  void (* MspInitCallback)(struct __HSP_HandleTypeDef *hhsp);

  /** HSP MSP DeInit callback function pointer */
  void (* MspDeInitCallback)(struct __HSP_HandleTypeDef *hhsp);
#endif /* USE_HAL_HSP_REGISTER_CALLBACKS */
} HSP_HandleTypeDef;

#if (USE_HAL_HSP_REGISTER_CALLBACKS == 1)
/**
  * @brief  HSP callback pointers definition
  */
...
HAL_StatusTypeDef HAL_HSP_LoadFirmware(HSP_HandleTypeDef *hhsp,
                                       const uint32_t *p_cram_bin, uint32_t cram_size_word,
                                       const uint32_t *p_dram_bin, uint32_t dram_size_word);
HAL_StatusTypeDef HAL_HSP_LoadPlugin(HSP_HandleTypeDef *hhsp, const uint32_t *p_plugin_bin, uint32_t size);

/* Boot functions *************************************************************/
HAL_StatusTypeDef HAL_HSP_Boot(HSP_HandleTypeDef *hhsp, const HAL_HSP_Boot_ConfigTypeDef *p_config,
                               uint32_t timeout_ms);
HAL_StatusTypeDef HAL_HSP_GetFirmwareVersion(HSP_HandleTypeDef *hhsp,
                                             HAL_HSP_FW_VersionTypeDef *p_rom_version,
                                             HAL_HSP_FW_VersionTypeDef *p_ram_version);
...
/**
  ...
  */
__STATIC_FORCEINLINE void HAL_HSP_DIRECT_WriteCommand(HSP_HandleTypeDef *hhsp, uint32_t cmd_id)
{
...
/**
  ...
  * @param  value     value.
  */
__STATIC_FORCEINLINE void HAL_HSP_WriteParameter(HSP_HandleTypeDef *hhsp,
                                                 HAL_HSP_PARAMTypeDef param_id, uint32_t value)
{
  __IO uint32_t *reg_param0 = &(hhsp->Instance->PARAMR0);
  reg_param0 += (uint32_t)param_id;
  STM32_WRITE_REG(*reg_param0, value);
}
...
HAL_StatusTypeDef HAL_HSP_MSGBOX_SendCommand(HSP_HandleTypeDef *hhsp, uint32_t command_id, uint32_t timeout);
...
{
  HSP_TypeDef *p_hspx = (HSP_TypeDef *)(hhsp->Instance);
...
/** @defgroup HSP_Exported_Functions_Group3 HSP Event management
  * @{
  */
/** @defgroup HSP_Exported_Functions_Group3_2 HSP STREAM Interface
  ...
  */
/* STREAM Interface --------------------------------------------------------- */
HAL_StatusTypeDef HAL_HSP_STREAM_EnableIntToFloat(HSP_HandleTypeDef *hhsp);
HAL_StatusTypeDef HAL_HSP_STREAM_DisableIntToFloat(HSP_HandleTypeDef *hhsp);
...
HAL_StatusTypeDef HAL_HSP_STREAM_Enable(HSP_HandleTypeDef *hhsp);
HAL_StatusTypeDef HAL_HSP_STREAM_Disable(HSP_HandleTypeDef *hhsp);
HAL_HSP_STREAM_StatusTypeDef HAL_HSP_STREAM_IsEnabled(const HSP_HandleTypeDef *hhsp);

HAL_StatusTypeDef HAL_HSP_STREAM_EVENT_EnableIT(HSP_HandleTypeDef *hhsp, uint32_t interrupts);
HAL_StatusTypeDef HAL_HSP_STREAM_EVENT_DisableIT(HSP_HandleTypeDef *hhsp, uint32_t interrupts);
HAL_StatusTypeDef HAL_HSP_STREAM_ERROR_EnableIT(HSP_HandleTypeDef *hhsp, uint32_t interrupts);
HAL_StatusTypeDef HAL_HSP_STREAM_ERROR_DisableIT(HSP_HandleTypeDef *hhsp, uint32_t interrupts);
uint32_t HAL_HSP_STREAM_EVENT_IsEnabledIT(const HSP_HandleTypeDef *hhsp, uint32_t interrupts);
uint32_t HAL_HSP_STREAM_ERROR_IsEnabledIT(const HSP_HandleTypeDef *hhsp, uint32_t interrupts);
...
/** @brief  Clears the specified HSP STREAM Buffer flag.
  * @param  hhsp  Pointer to a HSP_HandleTypeDef.
  ...
  *            @arg HAL_HSP_FLAG_EVT_STREAM_BUFFER_2: HSP STREAM Buffer 2 Ready flag
  *            @arg HAL_HSP_FLAG_EVT_STREAM_BUFFER_3: HSP STREAM Buffer 3 Ready flag
  *            @arg HAL_HSP_FLAG_EVT_STREAM_BUFFER_ALL:  All HSP STREAM Buffer flags
  */
__STATIC_INLINE void HAL_HSP_STREAM_ClearFlag_Event(HSP_HandleTypeDef *hhsp, uint32_t flags)
{
  HSP_TypeDef *p_hspx = hhsp->Instance;
...
/** @brief  Clears the specified HSP STREAM Buffer Error flag.
  ...
  */
__STATIC_INLINE void HAL_HSP_STREAM_ClearFlag_Error(HSP_HandleTypeDef *hhsp, uint32_t flags)
{
  HSP_TypeDef *p_hspx = hhsp->Instance;
...
/**
  ...
  * @param  hhsp  Pointer to a HSP_HandleTypeDef.
  * @param  id    Stream buffer id.
  * @retval Buffer Address
  */
__STATIC_INLINE volatile uint32_t *HAL_HSP_STREAM_GetBufferAddress(const HSP_HandleTypeDef *hhsp,
                                                                   HAL_HSP_STREAM_BufferTypeDef id)
{
  HSP_TypeDef *p_hspx = hhsp->Instance;

  return &(p_hspx->BUFFDR[(uint32_t)id]);
}
...
/** @brief  Clear the specified HSP TRGIN Overrun Error flag status.
  * @param  hhsp specifies the HSP Handle.
  */
__STATIC_INLINE void HAL_HSP_TRGIN_ClearFlag_Overrun(HSP_HandleTypeDef *hhsp)
{
  HSP_TypeDef *p_hspx = hhsp->Instance;

  STM32_WRITE_REG(p_hspx->EVT_ICR, HAL_HSP_FLAG_ERR_TRGIN_OVR);
}
...
HAL_StatusTypeDef HAL_HSP_TCU_EnableOverlap(HSP_HandleTypeDef *hhsp,
                                            HAL_HSP_TaskTypeDef lower_task_id, HAL_HSP_TaskTypeDef higher_task_id);
HAL_StatusTypeDef HAL_HSP_TCU_DisableOverlap(HSP_HandleTypeDef *hhsp);
HAL_HSP_TCU_TaskOverlap_StatusTypeDef HAL_HSP_TCU_IsEnabledOverlap(const HSP_HandleTypeDef *hhsp);

/* Start/End of Task Detection ---------------------------------------------- */
HAL_StatusTypeDef HAL_HSP_TCU_EnableComparator(HSP_HandleTypeDef *hhsp,
                                               HAL_HSP_TASK_ComparatorTypeDef tcu_id, HAL_HSP_TaskTypeDef task_id);
HAL_StatusTypeDef HAL_HSP_TCU_DisableComparator(HSP_HandleTypeDef *hhsp, HAL_HSP_TASK_ComparatorTypeDef tcu_id);
HAL_HSP_TCU_Comparator_StatusTypeDef HAL_HSP_TCU_IsEnabledComparator(const HSP_HandleTypeDef *hhsp,
                                                                     HAL_HSP_TASK_ComparatorTypeDef tcu_id);

/* Events/Interrupts Management --------------------------------------------- */
HAL_StatusTypeDef HAL_HSP_TCU_PollForEvent(HSP_HandleTypeDef *hhsp,
                                           HAL_HSP_POLLING_ModeTypeDef poll_mode, uint32_t flags_mask,
                                           uint32_t timeout_ms, uint32_t *p_events_mask_status);

HAL_StatusTypeDef HAL_HSP_TCU_EnableIT(HSP_HandleTypeDef *hhsp, uint32_t interrupts);
HAL_StatusTypeDef HAL_HSP_TCU_DisableIT(HSP_HandleTypeDef *hhsp, uint32_t interrupts);
uint32_t HAL_HSP_TCU_IsEnabledIT(const HSP_HandleTypeDef *hhsp, uint32_t interrupts);
...
/** @defgroup HSP_Exported_Functions_Group8 HSP Performance
  ...
  */
/* BRAM Access Control ------------------------------------------------------ */
HAL_StatusTypeDef HAL_HSP_BRAM_EnableConflictAccessCounter(HSP_HandleTypeDef *hhsp);
HAL_StatusTypeDef HAL_HSP_BRAM_DisableConflictAccessCounter(HSP_HandleTypeDef *hhsp);
...
HAL_StatusTypeDef HAL_HSP_BRAM_SetBandwidthArbitration(HSP_HandleTypeDef *hhsp,
...
/**
  ...
  * @param  hhsp  Pointer to a HSP_HandleTypeDef.
  */
__STATIC_INLINE void HAL_HSP_ClearFlag_FirmwareError(HSP_HandleTypeDef *hhsp)
{
  HSP_TypeDef *p_hspx = hhsp->Instance;
...
HAL_HSP_SPE_IT_StatusTypeDef HAL_HSP_SPE_EVENT_IsEnabledIT(const HSP_HandleTypeDef *hhsp, uint32_t interrupts);
...
HAL_HSP_SPE_IT_StatusTypeDef HAL_HSP_SPE_ERROR_IsEnabledIT(const HSP_HandleTypeDef *hhsp, uint32_t interrupts);
...
/** @defgroup HSP_Exported_Functions_Group9 HSP Snoop
  * @{
  */
HAL_StatusTypeDef HAL_HSP_SNOOP_Enable(HSP_HandleTypeDef *hhsp, HAL_HSP_SNOOP_GroupTypeDef group_id,
                                       HAL_HSP_SNOOP_SignalTypeDef source);
HAL_StatusTypeDef HAL_HSP_SNOOP_Disable(HSP_HandleTypeDef *hhsp, HAL_HSP_SNOOP_GroupTypeDef group_id);
...
/** @defgroup HSP_Exported_Functions_Group10 HSP Break Interface
  * @{
  */
HAL_StatusTypeDef HAL_HSP_BREAK_EnableCriticalEvent(HSP_HandleTypeDef *hhsp,
                                                    HAL_HSP_BREAK_OutputTypeDef output_id, uint32_t breaks_mask);
HAL_StatusTypeDef HAL_HSP_BREAK_DisableCriticalEvent(HSP_HandleTypeDef *hhsp,
                                                     HAL_HSP_BREAK_OutputTypeDef output_id, uint32_t breaks_mask);
...
HAL_StatusTypeDef HAL_HSP_BREAK_EnableFreezeEvent(HSP_HandleTypeDef *hhsp, uint32_t breaks_mask);
HAL_StatusTypeDef HAL_HSP_BREAK_DisableFreezeEvent(HSP_HandleTypeDef *hhsp, uint32_t breaks_mask);
...
/** @defgroup HSP_Exported_Functions_Group11 HSP Protection
  * @{
  */
HAL_StatusTypeDef HAL_HSP_Lock(HSP_HandleTypeDef *hhsp);
...
HAL_StatusTypeDef HAL_HSP_TASK_Run(HSP_HandleTypeDef *hhsp, HAL_HSP_TaskTypeDef pl_id, uint32_t timeout_ms);
HAL_StatusTypeDef HAL_HSP_TASK_Run_IT(HSP_HandleTypeDef *hhsp, HAL_HSP_TaskTypeDef pl_id);
...
HAL_StatusTypeDef HAL_HSP_PROCLIST_PollForNotification(HSP_HandleTypeDef *hhsp,
                                                       HAL_HSP_POLLING_ModeTypeDef poll_mode, uint32_t notifs_mask,
                                                       uint32_t timeout_ms, uint32_t *p_events_status);
HAL_StatusTypeDef HAL_HSP_PROCLIST_EnableIT(HSP_HandleTypeDef *hhsp, uint32_t notification_mask);
HAL_StatusTypeDef HAL_HSP_PROCLIST_DisableIT(HSP_HandleTypeDef *hhsp, uint32_t notification_mask);
uint32_t HAL_HSP_PROCLIST_IsEnabledIT(const HSP_HandleTypeDef *hhsp, uint32_t notification_mask);
...
HAL_StatusTypeDef HAL_HSP_RegisterEVT_SPE_DirectCommandCpltCallback(HSP_HandleTypeDef *hhsp,
                                                                    pHSP_CallbackTypeDef p_callback);
HAL_StatusTypeDef HAL_HSP_RegisterEVT_SPE_TaskCpltCallback(HSP_HandleTypeDef *hhsp,
                                                           pHSP_CallbackTypeDef p_callback);
HAL_StatusTypeDef HAL_HSP_RegisterEVT_SPE_FPUSaturationCallback(HSP_HandleTypeDef *hhsp,
                                                                pHSP_CallbackTypeDef p_callback);
HAL_StatusTypeDef HAL_HSP_RegisterEVT_SPE_RunStateCallback(HSP_HandleTypeDef *hhsp,
                                                           pHSP_OneParamCallbackTypeDef p_callback);
HAL_StatusTypeDef HAL_HSP_RegisterEVT_STREAM_BufferEmptyCallback(HSP_HandleTypeDef *hhsp,
                                                                 pHSP_OneParamCallbackTypeDef p_callback);
HAL_StatusTypeDef HAL_HSP_RegisterEVT_STREAM_BufferFullCallback(HSP_HandleTypeDef *hhsp,
                                                                pHSP_OneParamCallbackTypeDef p_callback);
HAL_StatusTypeDef HAL_HSP_RegisterEVT_TCU_TaskOverlapCallback(HSP_HandleTypeDef *hhsp,
                                                              pHSP_CallbackTypeDef p_callback);
HAL_StatusTypeDef HAL_HSP_RegisterEVT_TCU_TaskStartedCallback(HSP_HandleTypeDef *hhsp,
                                                              pHSP_OneParamCallbackTypeDef p_callback);
HAL_StatusTypeDef HAL_HSP_RegisterEVT_TCU_TaskEndedCallback(HSP_HandleTypeDef *hhsp,
                                                            pHSP_OneParamCallbackTypeDef p_callback);
HAL_StatusTypeDef HAL_HSP_RegisterEVT_TSC_TimestampReadyCallback(HSP_HandleTypeDef *hhsp,
                                                                 pHSP_OneParamCallbackTypeDef p_callback);
...
/** @defgroup HSP_Exported_Functions_Group14 HSP Handle control functions
  * @{
  */
