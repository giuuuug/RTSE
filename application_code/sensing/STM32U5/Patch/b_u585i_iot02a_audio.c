...
*/
    ...
    filterConfig.DecimationRatio = 24/*32*/;
    filterConfig.Gain = 10+4;
    filterConfig.ReshapeFilter.Activation = ENABLE;
    filterConfig.ReshapeFilter.DecimationRatio = MDF_RSF_DECIMATION_RATIO_4;
    filterConfig.HighPassFilter.Activation = ENABLE;
    filterConfig.HighPassFilter.CutOffFrequency = MDF_HPF_CUTOFF_0_000625FPCM;
    filterConfig.SoundActivity.Activation = ENABLE;
    filterConfig.SoundActivity.Mode = MDF_SAD_SOUND_DETECTOR;
    filterConfig.SoundActivity.FrameSize = MDF_SAD_64_PCM_SAMPLES;
    filterConfig.SoundActivity.Hysteresis = ENABLE;
    filterConfig.SoundActivity.SoundTriggerEvent = MDF_SAD_ENTER_EXIT_DETECT;
    filterConfig.SoundActivity.DataMemoryTransfer = MDF_SAD_MEMORY_TRANSFER_IN_DETECT;
    filterConfig.SoundActivity.MinNoiseLevel = 1000;
    filterConfig.SoundActivity.HangoverWindow = MDF_SAD_HANGOVER_512_FRAMES;
    filterConfig.SoundActivity.LearningFrames = MDF_SAD_LEARNING_2_FRAMES;
    filterConfig.SoundActivity.SignalNoiseThreshold = MDF_SAD_SIGNAL_NOISE_6DB;
    filterConfig.SoundActivity.SoundLevelInterrupt = DISABLE;
...
__weak HAL_StatusTypeDef MX_MDF1_Init(MDF_HandleTypeDef *hMdfBlock, MX_MDF_InitTypeDef *MXInit)
{
  ...
  */
  hMdfBlock->Instance = ADF1_Filter0;
  hMdfBlock->Init.CommonParam.ProcClockDivider = 1;
  hMdfBlock->Init.CommonParam.OutputClock.Activation = ENABLE;
  hMdfBlock->Init.CommonParam.OutputClock.Pins = MDF_OUTPUT_CLOCK_0;
  hMdfBlock->Init.CommonParam.OutputClock.Divider = 12;
  hMdfBlock->Init.CommonParam.OutputClock.Trigger.Activation = DISABLE;
  hMdfBlock->Init.SerialInterface.Activation = ENABLE;
  hMdfBlock->Init.SerialInterface.Mode = MDF_SITF_NORMAL_SPI_MODE;
  hMdfBlock->Init.SerialInterface.ClockSource = MDF_SITF_CCK0_SOURCE;
  hMdfBlock->Init.SerialInterface.Threshold = 31;
  hMdfBlock->Init.FilterBistream = MDF_BITSTREAM0_RISING;
#endif
