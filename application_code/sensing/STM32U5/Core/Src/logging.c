...
#define LOG_LEVEL_SYS_STR      "System"
...
/**
 * @brief gives the descriptive string associated to a given log level
 * @param LogLevel log level
 * @retval string associated to a given log level
 */
const char * getLogLevelStr(int LogLevel)
{
  ...
  case LOG_SYS: return LOG_LEVEL_SYS_STR;
...
/**
 * @brief Prints a formated string  according to its log level
 * @param LogLevel log level
