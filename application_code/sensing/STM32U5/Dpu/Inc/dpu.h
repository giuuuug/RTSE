...
#define CTRL_AI_GRAV_ROT_SUPPR        (1U)
#define CTRL_AI_GRAV_ROT              (2U)
#define CTRL_AI_SPECTROGRAM_MEL       (3U)
#define CTRL_AI_SPECTROGRAM_LOG_MEL   (4U)
#define CTRL_AI_SPECTROGRAM_MFCC      (5U)
#define CTRL_AI_SCALING               (6U)
#define CTRL_AI_BYPASS                (7U)
...
#ifndef CTRL_X_CUBE_AI_MODEL_NAME
#define CTRL_X_CUBE_AI_MODEL_NAME                 "X-CUBE-AI HAR"
#endif
#ifndef CTRL_X_CUBE_AI_MODEL_NETWORK_MODEL_NAME
#define CTRL_X_CUBE_AI_MODEL_NETWORK_MODEL_NAME   "network"
#endif
...
#endif
#ifndef CTRL_X_CUBE_AI_SENSOR_DIM
#define CTRL_X_CUBE_AI_SENSOR_DIM                (3)
#endif

//#ifndef CTRL_X_CUBE_AI_AUDIO_OUT
//#define CTRL_X_CUBE_AI_AUDIO_OUT                 COM_TYPE_NONE
//#endif  
...
#define CTRL_X_CUBE_AI_OOD_THR                    (0)
#endif
...
#define CTRL_X_CUBE_AI_ACQ_LENGTH_MS (uint32_t)(1000.0F * (float) CTRL_X_CUBE_AI_SPECTROGRAM_NFFT / (float) CTRL_X_CUBE_AI_SENSOR_ODR )
