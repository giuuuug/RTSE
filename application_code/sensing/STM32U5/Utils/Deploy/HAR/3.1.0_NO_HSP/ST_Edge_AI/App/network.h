...
#define STAI_NETWORK_ORIGIN_MODEL_NAME         "cnn_model_fft_ss7_quantized"
#define STAI_NETWORK_ORIGIN_MODEL_SIGNATURE    "0x2b3e13d7642bf5a8ed53b46ddcce5f06"

/*  Generated model name and signature  */
#define STAI_NETWORK_MODEL_NAME                "network"
#define STAI_NETWORK_MODEL_SIGNATURE           (0x26e3aa538832154a)
...
#define STAI_NETWORK_IN_1_SHAPE       {1,3,32}
#define STAI_NETWORK_IN_1_BATCH       (1)
#define STAI_NETWORK_IN_1_HEIGHT      (3)
#define STAI_NETWORK_IN_1_CHANNEL     (32)
#define STAI_NETWORK_IN_1_RANK        (2)
#define STAI_NETWORK_IN_1_SIZE        (96)
#define STAI_NETWORK_IN_1_SIZE_BYTES  (384)

/*****************************************************************************/
/*  Macros to declare output buffers characteristics  */
#define STAI_NETWORK_OUT_NUM             (1)
#define STAI_NETWORK_OUT_SIZE_BYTES      (32)
...
#define STAI_NETWORK_OUT_1_SHAPE       {1,7}
#define STAI_NETWORK_OUT_1_BATCH       (1)
#define STAI_NETWORK_OUT_1_CHANNEL     (7)
...
#define STAI_NETWORK_ACTIVATIONS_SIZE              (16768)
#define STAI_NETWORK_ACTIVATIONS_SIZE_BYTES        (16768)
...
#define STAI_NETWORK_ACTIVATION_1_SIZE       (16768)
#define STAI_NETWORK_ACTIVATION_1_SIZE_BYTES (16768)
...
#define STAI_NETWORK_WEIGHTS_SIZE                  (194524)
#define STAI_NETWORK_WEIGHTS_SIZE_BYTES            (194524)
...
#define STAI_NETWORK_WEIGHT_1_SIZE        (194524)
#define STAI_NETWORK_WEIGHT_1_SIZE_BYTES  (194524)
