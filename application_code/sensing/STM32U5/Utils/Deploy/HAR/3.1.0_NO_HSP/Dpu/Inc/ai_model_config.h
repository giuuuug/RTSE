...
#define CTRL_X_CUBE_AI_MODEL_CLASS_LIST        {"walking", "jogging", "stationary", "typing",  "writing", "clapping", "folding"}
#define CTRL_X_CUBE_AI_SENSOR_TYPE             (COM_TYPE_ACC)
#define CTRL_X_CUBE_AI_SENSOR_ODR              (26.0F)
#define CTRL_X_CUBE_AI_SENSOR_FS               (4.0F)
#define CTRL_X_CUBE_AI_PREPROC                 (CTRL_AI_FFT)
#define CTRL_X_CUBE_AI_SPECTROGRAM_NFFT        (64U) /* power of 2 closest to CTRL_X_CUBE_AI_WINDOW_LENGTH */ 
