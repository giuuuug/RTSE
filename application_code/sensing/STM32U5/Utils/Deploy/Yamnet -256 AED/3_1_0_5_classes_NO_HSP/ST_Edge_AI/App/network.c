...
/*****************************************************************************/
#define _STAI_NETWORK_MODEL_SIGNATURE     "0x090a9f9c7eb32c59dd460d0e4e863094"
#define _STAI_NETWORK_DATETIME            "2025-09-04T10:47:29+0200"
...
static const stai_network_info g_network_info = {
  ...
  .inputs = (stai_tensor[STAI_NETWORK_IN_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 4, 1, 96, 64, 1),
      STAI_DECLARE_ARRAY(float, 1, 0.05803732946515083f),
  ...
  .activations = (stai_tensor[STAI_NETWORK_ACTIVATIONS_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 1, 158720),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
  .weights = (stai_tensor[STAI_NETWORK_WEIGHTS_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 1, 137876),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(conv2d_2_output_array_intq, AI_STATIC,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.0677516832947731f),
    AI_PACK_INTQ_ZP(-128)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(conv2d_4_output_array_intq, AI_STATIC,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.06740834563970566f),
    AI_PACK_INTQ_ZP(-128)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(conv2d_6_output_array_intq, AI_STATIC,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.05513093248009682f),
    AI_PACK_INTQ_ZP(-128)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(conv2d_8_output_array_intq, AI_STATIC,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.045907627791166306f),
    AI_PACK_INTQ_ZP(-128)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(conv2d_10_output_array_intq, AI_STATIC,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.04436974599957466f),
    AI_PACK_INTQ_ZP(-128)))

/* Int quant #11 */
AI_INTQ_INFO_LIST_OBJ_DECLARE(pool_11_output_array_intq, AI_STATIC,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.009142369031906128f),
    AI_PACK_INTQ_ZP(-128)))
...
AI_TENSOR_OBJ_DECLARE(
  ...
  1, 0x1,
  AI_SHAPE_INIT(4, 1, 32, 32, 48), AI_STRIDE_INIT(4, 1, 48*32, 1, 32),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  10, 0x1,
  AI_SHAPE_INIT(4, 1, 32, 34, 50), AI_STRIDE_INIT(4, 1, 50*34, 1, 34),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  14, 0x1,
  AI_SHAPE_INIT(4, 1, 64, 32, 48), AI_STRIDE_INIT(4, 1, 48*32, 1, 32),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  19, 0x1,
  AI_SHAPE_INIT(4, 1, 64, 34, 50), AI_STRIDE_INIT(4, 1, 50*34, 1, 34),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  23, 0x1,
  AI_SHAPE_INIT(4, 1, 128, 16, 24), AI_STRIDE_INIT(4, 1, 24*16, 1, 16),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  28, 0x1,
  AI_SHAPE_INIT(4, 1, 128, 18, 26), AI_STRIDE_INIT(4, 1, 26*18, 1, 18),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  41, 0x1,
  AI_SHAPE_INIT(4, 1, 256, 8, 12), AI_STRIDE_INIT(4, 1, 12*8, 1, 8),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  46, 0x1,
  AI_SHAPE_INIT(4, 1, 256, 10, 14), AI_STRIDE_INIT(4, 1, 14*10, 1, 10),
...
void forward_lite_conv2d_1_pad_before(_stai_network_context* net_ctx)
{
  conv2d_0_output_array.data = AI_PTR(net_ctx->_activations[0] + 47196);
  conv2d_0_output_array.data_start = AI_PTR(net_ctx->_activations[0] + 47196);
  conv2d_1_pad_before_output_array.data = AI_PTR(net_ctx->_activations[0] + 47196);
  conv2d_1_pad_before_output_array.data_start = AI_PTR(net_ctx->_activations[0] + 47196);
...
void forward_lite_conv2d_3_pad_before(_stai_network_context* net_ctx)
{
  ...
  conv2d_3_pad_before_output_array.data = AI_PTR(net_ctx->_activations[0] + 0);
  conv2d_3_pad_before_output_array.data_start = AI_PTR(net_ctx->_activations[0] + 0);
  _STAI_NETWORK_EVENT_NODE_START_CB(3, 1, { conv2d_2_output.data->data});
  forward_pad(&conv2d_3_pad_before_layer);
  _STAI_NETWORK_EVENT_NODE_STOP_CB(3, 1, { conv2d_3_pad_before_output.data->data});
}
void forward_lite_conv2d_5_pad_before(_stai_network_context* net_ctx)
{
  conv2d_4_output_array.data = AI_PTR(net_ctx->_activations[0] + 1536);
  conv2d_4_output_array.data_start = AI_PTR(net_ctx->_activations[0] + 1536);
  conv2d_5_pad_before_output_array.data = AI_PTR(net_ctx->_activations[0] + 1536);
  conv2d_5_pad_before_output_array.data_start = AI_PTR(net_ctx->_activations[0] + 1536);
  _STAI_NETWORK_EVENT_NODE_START_CB(5, 1, { conv2d_4_output.data->data});
  forward_pad(&conv2d_5_pad_before_layer);
  _STAI_NETWORK_EVENT_NODE_STOP_CB(5, 1, { conv2d_5_pad_before_output.data->data});
}
void forward_lite_conv2d_7_pad_before(_stai_network_context* net_ctx)
{
  conv2d_6_output_array.data = AI_PTR(net_ctx->_activations[0] + 1792);
  conv2d_6_output_array.data_start = AI_PTR(net_ctx->_activations[0] + 1792);
  conv2d_7_pad_before_output_array.data = AI_PTR(net_ctx->_activations[0] + 1792);
  conv2d_7_pad_before_output_array.data_start = AI_PTR(net_ctx->_activations[0] + 1792);
  _STAI_NETWORK_EVENT_NODE_START_CB(7, 1, { conv2d_6_output.data->data});
  forward_pad(&conv2d_7_pad_before_layer);
  _STAI_NETWORK_EVENT_NODE_STOP_CB(7, 1, { conv2d_7_pad_before_output.data->data});
}
void forward_lite_conv2d_9_pad_before(_stai_network_context* net_ctx)
{
  conv2d_8_output_array.data = AI_PTR(net_ctx->_activations[0] + 3072);
  conv2d_8_output_array.data_start = AI_PTR(net_ctx->_activations[0] + 3072);
  conv2d_9_pad_before_output_array.data = AI_PTR(net_ctx->_activations[0] + 3072);
  conv2d_9_pad_before_output_array.data_start = AI_PTR(net_ctx->_activations[0] + 3072);
  _STAI_NETWORK_EVENT_NODE_START_CB(9, 1, { conv2d_8_output.data->data});
  forward_pad(&conv2d_9_pad_before_layer);
  _STAI_NETWORK_EVENT_NODE_STOP_CB(9, 1, { conv2d_9_pad_before_output.data->data});
}
void forward_lite_pool_11(_stai_network_context* net_ctx)
{
  conv2d_10_output_array.data = AI_PTR(net_ctx->_activations[0] + 3584);
  conv2d_10_output_array.data_start = AI_PTR(net_ctx->_activations[0] + 3584);
  pool_11_output_array.data = AI_PTR(net_ctx->_activations[0] + 0);
  pool_11_output_array.data_start = AI_PTR(net_ctx->_activations[0] + 0);
  _STAI_NETWORK_EVENT_NODE_START_CB(11, 1, { conv2d_10_output.data->data});
  forward_ap_integer_INT8(&pool_11_layer);
  _STAI_NETWORK_EVENT_NODE_STOP_CB(11, 1, { pool_11_output.data->data});
}
  ...
  const stai_run_mode mode)
{
  ...
  {
      const ai_i8* t_in_0_ptr_const_s8 = (ai_i8*)(net_ctx->_inputs[0] + 0);
    const ai_u16 t_in_0_shape_w_const_u16 = 64;
    const ai_u16 t_in_0_shape_h_const_u16 = 96;
    const ai_u16 t_in_0_shape_ch_const_u16 = 1;
    const ai_i8* t_weight_0_ptr_const_s8 = (ai_i8*)(net_ctx->_weights[0] + 0);
    const ai_u16 t_out_0_shape_ch_const_u16 = 32;
    const ai_u16 t_weight_0_shape_w_const_u16 = 3;
    const ai_u16 t_weight_0_shape_h_const_u16 = 3;
  ...
  forward_lite_conv2d_1_pad_before(net_ctx);
  }
  /* LITE_KERNEL_SECTION END conv2d_1_pad_before */
  /* LITE_KERNEL_SECTION BEGIN conv2d_1 */
  {
      const ai_i8* t_in_0_ptr_const_s8 = (ai_i8*)(net_ctx->_activations[0] + 47196);
    const ai_u16 t_in_0_shape_w_const_u16 = 34;
    const ai_u16 t_in_0_shape_h_const_u16 = 50;
    const ai_u16 t_in_0_shape_ch_const_u16 = 32;
    const ai_i8* t_weight_0_ptr_const_s8 = (ai_i8*)(net_ctx->_weights[0] + 416);
    const ai_u16 l_stride_1_const_u16 = 1;
    const ai_u16 l_stride_0_const_u16 = 1;
    const ai_i32* t_weight_1_ptr_const_s32 = (ai_i32*)(net_ctx->_weights[0] + 704);
    const ai_i8 t_in_0_fmt_zero_const_s8 = -128;
    const ai_i8 t_out_0_fmt_zero_const_s8 = -128;
    const ai_float t_in_0_fmt_scale_const_f32 = 0.06457148492336273f;
    const ai_float t_out_0_fmt_scale_const_f32 = 0.07393850386142731f;
    const ai_float t_weight_0_fmt_scale_const_f32[] = LITE_ARRAY_VALUES(0.010400666855275631f, 0.012416824698448181f, 0.009986218996345997f, 0.013823737390339375f, 0.009749474935233593f, 0.008367353118956089f, 0.011490069329738617f, 0.012336155399680138f, 0.0051926192827522755f, 0.012839957140386105f, 0.010829677805304527f, 0.016020964831113815f, 0.01128245797008276f, 0.012446494773030281f, 0.008876626379787922f, 0.010049762204289436f, 0.012603728100657463f, 0.006812460254877806f, 0.010264375247061253f, 0.013542493805289268f, 0.004623067565262318f, 0.006609706673771143f, 0.00553264282643795f, 0.009713215753436089f, 0.005326559767127037f, 0.016724994406104088f, 0.00921869557350874f, 0.011204401962459087f, 0.009224574081599712f, 0.013367131352424622f, 0.010990303941071033f, 0.013431142084300518f);
    ai_i8* t_out_0_ptr_s8 = (ai_i8*)(net_ctx->_activations[0] + 108800);
    const ai_u16 t_out_0_shape_w_const_u16 = 32;
    const ai_u16 t_out_0_shape_h_const_u16 = 48;
    ai_i16* t_scratch_0_ptr_s16 = (ai_i16*)(net_ctx->_activations[0] + 107712);
  
  _STAI_NETWORK_EVENT_NODE_START_CB(1, 1, {(stai_ptr) t_in_0_ptr_const_s8});
    
  forward_lite_dw_3x3_ch1st_sssa8_ch(t_in_0_ptr_const_s8, t_in_0_shape_w_const_u16, t_in_0_shape_h_const_u16, t_in_0_shape_ch_const_u16, t_weight_0_ptr_const_s8, l_stride_1_const_u16, l_stride_0_const_u16, t_weight_1_ptr_const_s32, t_in_0_fmt_zero_const_s8, t_out_0_fmt_zero_const_s8, t_in_0_fmt_scale_const_f32, t_out_0_fmt_scale_const_f32, t_weight_0_fmt_scale_const_f32, t_out_0_ptr_s8, t_out_0_shape_w_const_u16, t_out_0_shape_h_const_u16, 0, 1088, t_scratch_0_ptr_s16);
    
  _STAI_NETWORK_EVENT_NODE_STOP_CB(1, 1, {(stai_ptr) t_out_0_ptr_s8});
  }
  /* LITE_KERNEL_SECTION END conv2d_1 */
  /* LITE_KERNEL_SECTION BEGIN conv2d_2 */
  {
      const ai_i8* t_in_0_ptr_const_s8 = (ai_i8*)(net_ctx->_activations[0] + 108800);
    const ai_u16 t_in_0_shape_w_const_u16 = 32;
    const ai_u16 t_in_0_shape_h_const_u16 = 48;
    const ai_u16 l_stride_1_const_u16 = 1;
    const ai_u16 l_stride_0_const_u16 = 1;
    const ai_u16 t_in_0_shape_ch_const_u16 = 32;
  ...
  {
      ai_i8* t_out_0_ptr_s8 = (ai_i8*)(net_ctx->_activations[0] + 0);
    const ai_i8* t_in_0_ptr_const_s8 = (ai_i8*)(net_ctx->_activations[0] + 768);
    const ai_u32 t_in_0_shape_ch_prod_const_u32 = 5;
    ai_i32* t_scratch_0_ptr_s32 = (ai_i32*)(net_ctx->_activations[0] + 776);
  
  _STAI_NETWORK_EVENT_NODE_START_CB(13, 1, {(stai_ptr) t_in_0_ptr_const_s8});
    
  forward_lite_nl_softmax_is8os8(t_out_0_ptr_s8, t_in_0_ptr_const_s8, t_in_0_shape_ch_prod_const_u32, 1, 5, 1815422848, 22, -496, t_scratch_0_ptr_s32);
  ...
  /* LITE_KERNEL_SECTION BEGIN conversion_14 */
  {
    ...
    const ai_u32 t_out_0_shape_h_w_ch_d_prod_const_u32 = 5;
    const ai_float t_in_0_fmt_scale_const_f32 = 0.00390625f;
    const ai_i8 t_in_0_fmt_zero_const_s8 = -128;
  
  _STAI_NETWORK_EVENT_NODE_START_CB(14, 1, {(stai_ptr) t_in_0_ptr_const_s8});
...
const uintptr_t _activations_alignment[] = STAI_NETWORK_ACTIVATIONS_ALIGNMENTS;
  ...
  net_ctx->_inputs[0] = activations[0] + 101596;
