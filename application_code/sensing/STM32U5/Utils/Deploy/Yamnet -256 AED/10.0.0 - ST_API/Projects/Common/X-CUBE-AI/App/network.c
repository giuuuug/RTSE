...
/*****************************************************************************/
#define _STAI_NETWORK_MODEL_SIGNATURE     "0xa039a0d222b3aa99ed18bb3c8eecf8a4"
#define _STAI_NETWORK_DATETIME            "2025-01-30T10:18:44+0100"
...
static const stai_network_info g_network_info = {
  ...
  .inputs = (stai_tensor[STAI_NETWORK_IN_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(float, 1, 0.054722581058740616f),
...
/* Int quant #0 */
AI_INTQ_INFO_LIST_OBJ_DECLARE(serving_default_input_10_output_array_intq, AI_STATIC,
...
{
  serving_default_input_10_output_array.data = AI_PTR(net_ctx->_inputs[0] + 0);
  serving_default_input_10_output_array.data_start = AI_PTR(net_ctx->_inputs[0] + 0);
  ...
  _STAI_NETWORK_EVENT_NODE_START_CB(0, 1, { serving_default_input_10_output.data->data});
  ...
  const stai_run_mode mode)
{
  ...
  {
      const ai_i8* t_in_0_ptr_const_s8 = (ai_i8*)(net_ctx->_activations[0] + 62720);
    ...
    const ai_float t_in_0_fmt_scale_const_f32 = 0.054722581058740616f;
    ...
    ai_i8* t_out_0_ptr_s8 = (ai_i8*)(net_ctx->_activations[0] + 13568);
    const ai_u16 t_out_0_shape_w_const_u16 = 32;
    const ai_u16 t_out_0_shape_h_const_u16 = 48;
    ai_i16* t_scratch_0_ptr_s16 = (ai_i16*)(net_ctx->_activations[0] + 73948);
  ...
  {
      const ai_ptr t_in_0_ptr_const_ptr = (ai_ptr)(net_ctx->_activations[0] + 13568);
    ai_ptr t_out_0_ptr_ptr = (ai_ptr)(net_ctx->_activations[0] + 8320);
    const ai_i8 v_pad_constant_value_const_s8[] = LITE_ARRAY_VALUES(-128);
    const ai_i16 t_in_0_fmt_bitsize_const_s16 = 8;
    const ai_u32 t_in_0_shape_h_const_u32 = 48;
  
  _STAI_NETWORK_EVENT_NODE_START_CB(2, 1, {(stai_ptr) t_in_0_ptr_const_ptr});
    
  forward_lite_pad_constant(t_in_0_ptr_const_ptr, t_out_0_ptr_ptr, (ai_handle)(v_pad_constant_value_const_s8), t_in_0_fmt_bitsize_const_s16, t_in_0_shape_h_const_u32, (ai_i32)(1), (ai_i32)(1024), (ai_i32)(1088), (ai_i32)(1088), (ai_i32)(32), (ai_i32)(32));
    
  _STAI_NETWORK_EVENT_NODE_STOP_CB(2, 1, {(stai_ptr) t_out_0_ptr_ptr});
  }
  /* LITE_KERNEL_SECTION END conv2d_2_pad_before */
  /* LITE_KERNEL_SECTION BEGIN conv2d_2 */
  {
      const ai_i8* t_in_0_ptr_const_s8 = (ai_i8*)(net_ctx->_activations[0] + 8320);
    ...
    ai_i8* t_out_0_ptr_s8 = (ai_i8*)(net_ctx->_activations[0] + 62720);
    const ai_u16 t_out_0_shape_w_const_u16 = 32;
    const ai_u16 t_out_0_shape_h_const_u16 = 48;
    ai_i16* t_scratch_0_ptr_s16 = (ai_i16*)(net_ctx->_activations[0] + 7132);
  
  _STAI_NETWORK_EVENT_NODE_START_CB(2, 1, {(stai_ptr) t_in_0_ptr_const_s8});
    
  forward_lite_dw_3x3_sssa8_ch(t_in_0_ptr_const_s8, t_in_0_shape_w_const_u16, t_in_0_shape_h_const_u16, t_in_0_shape_ch_const_u16, t_weight_0_ptr_const_s8, l_stride_1_const_u16, l_stride_0_const_u16, t_weight_1_ptr_const_s32, t_in_0_fmt_zero_const_s8, t_out_0_fmt_zero_const_s8, t_in_0_fmt_scale_const_f32, t_out_0_fmt_scale_const_f32, t_weight_0_fmt_scale_const_f32, t_out_0_ptr_s8, t_out_0_shape_w_const_u16, t_out_0_shape_h_const_u16, 0, 1185, t_scratch_0_ptr_s16);
  ...
  /* LITE_KERNEL_SECTION BEGIN conv2d_3 */
  {
    ...
    const ai_float t_out_0_fmt_scale_const_f32 = 0.06574312597513199f;
    ...
    const ai_layer_format_type l_out_ch_format_const_layer_format_type = AI_LAYER_FORMAT_CHANNEL_LAST_VALID;
    ai_i8* t_out_0_ptr_s8 = (ai_i8*)(net_ctx->_activations[0] + 11520);
    ai_i16* t_scratch_0_ptr_s16 = (ai_i16*)(net_ctx->_activations[0] + 7132);
  ...
  {
      const ai_ptr t_in_0_ptr_const_ptr = (ai_ptr)(net_ctx->_activations[0] + 11520);
    ai_ptr t_out_0_ptr_ptr = (ai_ptr)(net_ctx->_activations[0] + 1024);
    const ai_i8 v_pad_constant_value_const_s8[] = LITE_ARRAY_VALUES(-128);
    const ai_i16 t_in_0_fmt_bitsize_const_s16 = 8;
    const ai_u32 t_in_0_shape_h_const_u32 = 48;
  
  _STAI_NETWORK_EVENT_NODE_START_CB(4, 1, {(stai_ptr) t_in_0_ptr_const_ptr});
    
  forward_lite_pad_constant(t_in_0_ptr_const_ptr, t_out_0_ptr_ptr, (ai_handle)(v_pad_constant_value_const_s8), t_in_0_fmt_bitsize_const_s16, t_in_0_shape_h_const_u32, (ai_i32)(1), (ai_i32)(2048), (ai_i32)(0), (ai_i32)(4352), (ai_i32)(0), (ai_i32)(128));
    
  _STAI_NETWORK_EVENT_NODE_STOP_CB(4, 1, {(stai_ptr) t_out_0_ptr_ptr});
  }
  /* LITE_KERNEL_SECTION END conv2d_4_pad_before */
  /* LITE_KERNEL_SECTION BEGIN conv2d_4 */
  {
      const ai_i8* t_in_0_ptr_const_s8 = (ai_i8*)(net_ctx->_activations[0] + 1024);
    const ai_u16 t_in_0_shape_w_const_u16 = 34;
    const ai_u16 t_in_0_shape_h_const_u16 = 50;
    ...
    const ai_i8 t_in_0_fmt_zero_const_s8 = -128;
    const ai_i8 t_out_0_fmt_zero_const_s8 = -128;
    const ai_float t_in_0_fmt_scale_const_f32 = 0.06574312597513199f;
    const ai_float t_out_0_fmt_scale_const_f32 = 0.06126588582992554f;
    ...
    ai_i16* t_scratch_0_ptr_s16 = (ai_i16*)(net_ctx->_activations[0] + 109824);
  
  _STAI_NETWORK_EVENT_NODE_START_CB(4, 1, {(stai_ptr) t_in_0_ptr_const_s8});
    
  forward_lite_dw_3x3_sssa8_ch(t_in_0_ptr_const_s8, t_in_0_shape_w_const_u16, t_in_0_shape_h_const_u16, t_in_0_shape_ch_const_u16, t_weight_0_ptr_const_s8, l_stride_1_const_u16, l_stride_0_const_u16, t_weight_1_ptr_const_s32, t_in_0_fmt_zero_const_s8, t_out_0_fmt_zero_const_s8, t_in_0_fmt_scale_const_f32, t_out_0_fmt_scale_const_f32, t_weight_0_fmt_scale_const_f32, t_out_0_ptr_s8, t_out_0_shape_w_const_u16, t_out_0_shape_h_const_u16, 0, 2369, t_scratch_0_ptr_s16);
  ...
  /* LITE_KERNEL_SECTION BEGIN conv2d_5 */
  {
    ...
    const ai_i8 t_in_0_fmt_zero_const_s8 = -128;
    const ai_i8 t_out_0_fmt_zero_const_s8 = -128;
    const ai_float t_in_0_fmt_scale_const_f32 = 0.06126588582992554f;
    const ai_float t_out_0_fmt_scale_const_f32 = 0.04955501854419708f;
    ...
    const ai_layer_format_type l_out_ch_format_const_layer_format_type = AI_LAYER_FORMAT_CHANNEL_LAST_VALID;
    ai_i8* t_out_0_ptr_s8 = (ai_i8*)(net_ctx->_activations[0] + 26112);
    ai_i16* t_scratch_0_ptr_s16 = (ai_i16*)(net_ctx->_activations[0] + 24576);
  ...
  {
      const ai_ptr t_in_0_ptr_const_ptr = (ai_ptr)(net_ctx->_activations[0] + 26112);
    ai_ptr t_out_0_ptr_ptr = (ai_ptr)(net_ctx->_activations[0] + 15360);
    const ai_i8 v_pad_constant_value_const_s8[] = LITE_ARRAY_VALUES(-128);
    const ai_i16 t_in_0_fmt_bitsize_const_s16 = 8;
    const ai_u32 t_in_0_shape_h_const_u32 = 24;
  
  _STAI_NETWORK_EVENT_NODE_START_CB(6, 1, {(stai_ptr) t_in_0_ptr_const_ptr});
    
  forward_lite_pad_constant(t_in_0_ptr_const_ptr, t_out_0_ptr_ptr, (ai_handle)(v_pad_constant_value_const_s8), t_in_0_fmt_bitsize_const_s16, t_in_0_shape_h_const_u32, (ai_i32)(1), (ai_i32)(2048), (ai_i32)(2304), (ai_i32)(2304), (ai_i32)(128), (ai_i32)(128));
    
  _STAI_NETWORK_EVENT_NODE_STOP_CB(6, 1, {(stai_ptr) t_out_0_ptr_ptr});
  }
  /* LITE_KERNEL_SECTION END conv2d_6_pad_before */
  /* LITE_KERNEL_SECTION BEGIN conv2d_6 */
  {
      const ai_i8* t_in_0_ptr_const_s8 = (ai_i8*)(net_ctx->_activations[0] + 15360);
    ...
    const ai_i8 t_in_0_fmt_zero_const_s8 = -128;
    const ai_i8 t_out_0_fmt_zero_const_s8 = -128;
    const ai_float t_in_0_fmt_scale_const_f32 = 0.04955501854419708f;
    const ai_float t_out_0_fmt_scale_const_f32 = 0.05997737497091293f;
    ...
    ai_i8* t_out_0_ptr_s8 = (ai_i8*)(net_ctx->_activations[0] + 13312);
    const ai_u16 t_out_0_shape_w_const_u16 = 16;
    const ai_u16 t_out_0_shape_h_const_u16 = 24;
  ...
  forward_lite_dw_3x3_sssa8_ch(t_in_0_ptr_const_s8, t_in_0_shape_w_const_u16, t_in_0_shape_h_const_u16, t_in_0_shape_ch_const_u16, t_weight_0_ptr_const_s8, l_stride_1_const_u16, l_stride_0_const_u16, t_weight_1_ptr_const_s32, t_in_0_fmt_zero_const_s8, t_out_0_fmt_zero_const_s8, t_in_0_fmt_scale_const_f32, t_out_0_fmt_scale_const_f32, t_weight_0_fmt_scale_const_f32, t_out_0_ptr_s8, t_out_0_shape_w_const_u16, t_out_0_shape_h_const_u16, 0, 4737, t_scratch_0_ptr_s16);
  ...
  {
      const ai_i8* t_in_0_ptr_const_s8 = (ai_i8*)(net_ctx->_activations[0] + 13312);
    const ai_u16 t_in_0_shape_w_const_u16 = 16;
    const ai_u16 t_in_0_shape_h_const_u16 = 24;
    const ai_u16 l_stride_1_const_u16 = 1;
    const ai_u16 l_stride_0_const_u16 = 1;
    ...
    const ai_i8 t_in_0_fmt_zero_const_s8 = -128;
    const ai_i8 t_out_0_fmt_zero_const_s8 = -128;
    const ai_float t_in_0_fmt_scale_const_f32 = 0.05997737497091293f;
    const ai_float t_out_0_fmt_scale_const_f32 = 0.04998200386762619f;
    ...
    const ai_layer_format_type l_out_ch_format_const_layer_format_type = AI_LAYER_FORMAT_CHANNEL_LAST_VALID;
    ai_i8* t_out_0_ptr_s8 = (ai_i8*)(net_ctx->_activations[0] + 62464);
    ai_i16* t_scratch_0_ptr_s16 = (ai_i16*)(net_ctx->_activations[0] + 0);
  ...
  {
      const ai_ptr t_in_0_ptr_const_ptr = (ai_ptr)(net_ctx->_activations[0] + 62464);
    ai_ptr t_out_0_ptr_ptr = (ai_ptr)(net_ctx->_activations[0] + 0);
    const ai_i8 v_pad_constant_value_const_s8[] = LITE_ARRAY_VALUES(-128);
    const ai_i16 t_in_0_fmt_bitsize_const_s16 = 8;
    const ai_u32 t_in_0_shape_h_const_u32 = 24;
  
  _STAI_NETWORK_EVENT_NODE_START_CB(8, 1, {(stai_ptr) t_in_0_ptr_const_ptr});
    
  forward_lite_pad_constant(t_in_0_ptr_const_ptr, t_out_0_ptr_ptr, (ai_handle)(v_pad_constant_value_const_s8), t_in_0_fmt_bitsize_const_s16, t_in_0_shape_h_const_u32, (ai_i32)(1), (ai_i32)(2048), (ai_i32)(0), (ai_i32)(4608), (ai_i32)(0), (ai_i32)(256));
    
  _STAI_NETWORK_EVENT_NODE_STOP_CB(8, 1, {(stai_ptr) t_out_0_ptr_ptr});
  }
  ...
  /* LITE_KERNEL_SECTION BEGIN conv2d_8 */
  {
    ...
    const ai_i8 t_in_0_fmt_zero_const_s8 = -128;
    const ai_i8 t_out_0_fmt_zero_const_s8 = -128;
    const ai_float t_in_0_fmt_scale_const_f32 = 0.04998200386762619f;
    const ai_float t_out_0_fmt_scale_const_f32 = 0.07021339237689972f;
    ...
    ai_i8* t_out_0_ptr_s8 = (ai_i8*)(net_ctx->_activations[0] + 64644);
    const ai_u16 t_out_0_shape_w_const_u16 = 8;
    const ai_u16 t_out_0_shape_h_const_u16 = 12;
    ai_i16* t_scratch_0_ptr_s16 = (ai_i16*)(net_ctx->_activations[0] + 59904);
  ...
  {
      const ai_i8* t_in_0_ptr_const_s8 = (ai_i8*)(net_ctx->_activations[0] + 64644);
    ...
    const ai_i8 t_in_0_fmt_zero_const_s8 = -128;
    const ai_i8 t_out_0_fmt_zero_const_s8 = -128;
    const ai_float t_in_0_fmt_scale_const_f32 = 0.07021339237689972f;
    const ai_float t_out_0_fmt_scale_const_f32 = 0.03831614926457405f;
  ...
  {
      const ai_ptr t_in_0_ptr_const_ptr = (ai_ptr)(net_ctx->_activations[0] + 3072);
    ai_ptr t_out_0_ptr_ptr = (ai_ptr)(net_ctx->_activations[0] + 27648);
    const ai_i8 v_pad_constant_value_const_s8[] = LITE_ARRAY_VALUES(-128);
    const ai_i16 t_in_0_fmt_bitsize_const_s16 = 8;
    const ai_u32 t_in_0_shape_h_const_u32 = 12;
  
  _STAI_NETWORK_EVENT_NODE_START_CB(10, 1, {(stai_ptr) t_in_0_ptr_const_ptr});
    
  forward_lite_pad_constant(t_in_0_ptr_const_ptr, t_out_0_ptr_ptr, (ai_handle)(v_pad_constant_value_const_s8), t_in_0_fmt_bitsize_const_s16, t_in_0_shape_h_const_u32, (ai_i32)(1), (ai_i32)(2048), (ai_i32)(2560), (ai_i32)(2560), (ai_i32)(256), (ai_i32)(256));
    
  _STAI_NETWORK_EVENT_NODE_STOP_CB(10, 1, {(stai_ptr) t_out_0_ptr_ptr});
  }
  /* LITE_KERNEL_SECTION END conv2d_10_pad_before */
  /* LITE_KERNEL_SECTION BEGIN conv2d_10 */
  {
      const ai_i8* t_in_0_ptr_const_s8 = (ai_i8*)(net_ctx->_activations[0] + 27648);
    ...
    const ai_i8 t_in_0_fmt_zero_const_s8 = -128;
    const ai_i8 t_out_0_fmt_zero_const_s8 = -128;
    const ai_float t_in_0_fmt_scale_const_f32 = 0.03831614926457405f;
    const ai_float t_out_0_fmt_scale_const_f32 = 0.06167426332831383f;
    ...
    ai_i8* t_out_0_ptr_s8 = (ai_i8*)(net_ctx->_activations[0] + 63488);
    const ai_u16 t_out_0_shape_w_const_u16 = 8;
    const ai_u16 t_out_0_shape_h_const_u16 = 12;
    ai_i16* t_scratch_0_ptr_s16 = (ai_i16*)(net_ctx->_activations[0] + 0);
  ...
  forward_lite_dw_3x3_sssa8_ch(t_in_0_ptr_const_s8, t_in_0_shape_w_const_u16, t_in_0_shape_h_const_u16, t_in_0_shape_ch_const_u16, t_weight_0_ptr_const_s8, l_stride_1_const_u16, l_stride_0_const_u16, t_weight_1_ptr_const_s32, t_in_0_fmt_zero_const_s8, t_out_0_fmt_zero_const_s8, t_in_0_fmt_scale_const_f32, t_out_0_fmt_scale_const_f32, t_weight_0_fmt_scale_const_f32, t_out_0_ptr_s8, t_out_0_shape_w_const_u16, t_out_0_shape_h_const_u16, 0, 9473, t_scratch_0_ptr_s16);
  ...
  {
      const ai_i8* t_in_0_ptr_const_s8 = (ai_i8*)(net_ctx->_activations[0] + 63488);
    const ai_u16 t_in_0_shape_w_const_u16 = 8;
    const ai_u16 t_in_0_shape_h_const_u16 = 12;
    const ai_u16 l_stride_1_const_u16 = 1;
    const ai_u16 l_stride_0_const_u16 = 1;
    ...
    const ai_i8 t_in_0_fmt_zero_const_s8 = -128;
    const ai_i8 t_out_0_fmt_zero_const_s8 = -128;
    const ai_float t_in_0_fmt_scale_const_f32 = 0.06167426332831383f;
    const ai_float t_out_0_fmt_scale_const_f32 = 0.034508027136325836f;
  ...
  _STAI_NETWORK_EVENT_NODE_START_CB(11, 1, {(stai_ptr) t_in_0_ptr_const_s8});
    
  forward_lite_pw_sssa8_ch(t_in_0_ptr_const_s8, t_in_0_shape_w_const_u16, t_in_0_shape_h_const_u16, l_stride_1_const_u16, l_stride_0_const_u16, t_in_0_shape_ch_const_u16, t_weight_0_ptr_const_s8, t_out_0_shape_ch_const_u16, t_weight_1_ptr_const_s32, t_in_0_fmt_zero_const_s8, t_out_0_fmt_zero_const_s8, t_in_0_fmt_scale_const_f32, t_out_0_fmt_scale_const_f32, t_weight_0_fmt_scale_const_f32, l_out_ch_format_const_layer_format_type, t_out_0_ptr_s8, 1, 3584, t_scratch_0_ptr_s16);
    
  _STAI_NETWORK_EVENT_NODE_STOP_CB(11, 1, {(stai_ptr) t_out_0_ptr_s8});
  }
  ...
  /* LITE_KERNEL_SECTION BEGIN gemm_13 */
  {
    ...
    const ai_i32* t_weight_1_ptr_const_s32 = (ai_i32*)(net_ctx->_weights[0] + 139136);
    const ai_i8 t_in_0_fmt_zero_const_s8 = -128;
    const ai_i8 t_out_0_fmt_zero_const_s8 = 66;
    const ai_u16 t_in_0_shape_ch_const_u16 = 256;
    const ai_u16 t_out_0_shape_ch_const_u16 = 10;
    const ai_u32 t_out_0_shape_h_w_prod_const_u32 = 1;
    const ai_float t_in_0_fmt_scale_const_f32 = 0.008966219611465931f;
    const ai_float t_out_0_fmt_scale_const_f32 = 0.10980255156755447f;
    const ai_float t_weight_0_fmt_scale_const_f32 = 0.009824128821492195f;
  ...
  /* LITE_KERNEL_SECTION BEGIN nl_14 */
  {
    ...
    const ai_u32 t_in_0_shape_ch_prod_const_u32 = 10;
    ai_i32* t_scratch_0_ptr_s32 = (ai_i32*)(net_ctx->_activations[0] + 780);
  
  _STAI_NETWORK_EVENT_NODE_START_CB(14, 1, {(stai_ptr) t_in_0_ptr_const_s8});
    
  forward_lite_nl_softmax_is8os8(t_out_0_ptr_s8, t_in_0_ptr_const_s8, t_in_0_shape_ch_prod_const_u32, 1, 10, 1886393472, 23, -248, t_scratch_0_ptr_s32);
    
  _STAI_NETWORK_EVENT_NODE_STOP_CB(14, 1, {(stai_ptr) t_out_0_ptr_s8});
  }
  ...
  /* LITE_KERNEL_SECTION BEGIN conversion_15 */
  {
    ...
    const ai_u32 t_out_0_shape_h_w_ch_d_prod_const_u32 = 10;
