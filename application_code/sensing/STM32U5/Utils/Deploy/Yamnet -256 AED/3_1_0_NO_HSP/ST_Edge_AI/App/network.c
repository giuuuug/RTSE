...
/*****************************************************************************/
#define _STAI_NETWORK_MODEL_SIGNATURE     "0x6e9e457618100f558dd18b2090fead3e"
#define _STAI_NETWORK_DATETIME            "2025-08-13T15:37:34+0200"
...
static const stai_network_info g_network_info = {
  ...
  .inputs = (stai_tensor[STAI_NETWORK_IN_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(float, 1, 0.05471150577068329f),
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(conv2d_4_output_array_intq, AI_STATIC,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.04955274611711502f),
    AI_PACK_INTQ_ZP(-128)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(conv2d_6_output_array_intq, AI_STATIC,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.04988973215222359f),
    AI_PACK_INTQ_ZP(-128)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(conv2d_8_output_array_intq, AI_STATIC,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.03830137848854065f),
    AI_PACK_INTQ_ZP(-128)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(conv2d_10_output_array_intq, AI_STATIC,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.03443523123860359f),
    AI_PACK_INTQ_ZP(-128)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(pool_11_output_array_intq, AI_STATIC,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.008963529951870441f),
    AI_PACK_INTQ_ZP(-128)))
  ...
  const stai_run_mode mode)
{
  ...
  /* LITE_KERNEL_SECTION BEGIN conv2d_0 */
  {
    ...
    const ai_float t_in_0_fmt_scale_const_f32 = 0.05471150577068329f;
  ...
  /* LITE_KERNEL_SECTION BEGIN conv2d_3 */
  {
    ...
    const ai_float t_out_0_fmt_scale_const_f32 = 0.06127312779426575f;
  ...
  /* LITE_KERNEL_SECTION BEGIN conv2d_4 */
  {
    ...
    const ai_i8 t_in_0_fmt_zero_const_s8 = -128;
    const ai_i8 t_out_0_fmt_zero_const_s8 = -128;
    const ai_float t_in_0_fmt_scale_const_f32 = 0.06127312779426575f;
    const ai_float t_out_0_fmt_scale_const_f32 = 0.04955274611711502f;
  ...
  /* LITE_KERNEL_SECTION BEGIN conv2d_5 */
  {
    ...
    const ai_i8 t_in_0_fmt_zero_const_s8 = -128;
    const ai_i8 t_out_0_fmt_zero_const_s8 = -128;
    const ai_float t_in_0_fmt_scale_const_f32 = 0.04955274611711502f;
    const ai_float t_out_0_fmt_scale_const_f32 = 0.05996210500597954f;
  ...
  /* LITE_KERNEL_SECTION BEGIN conv2d_6 */
  {
    ...
    const ai_i8 t_in_0_fmt_zero_const_s8 = -128;
    const ai_i8 t_out_0_fmt_zero_const_s8 = -128;
    const ai_float t_in_0_fmt_scale_const_f32 = 0.05996210500597954f;
    const ai_float t_out_0_fmt_scale_const_f32 = 0.04988973215222359f;
  ...
  /* LITE_KERNEL_SECTION BEGIN conv2d_7 */
  {
    ...
    const ai_i8 t_in_0_fmt_zero_const_s8 = -128;
    const ai_i8 t_out_0_fmt_zero_const_s8 = -128;
    const ai_float t_in_0_fmt_scale_const_f32 = 0.04988973215222359f;
    const ai_float t_out_0_fmt_scale_const_f32 = 0.07013958692550659f;
  ...
  /* LITE_KERNEL_SECTION BEGIN conv2d_8 */
  {
    ...
    const ai_i8 t_in_0_fmt_zero_const_s8 = -128;
    const ai_i8 t_out_0_fmt_zero_const_s8 = -128;
    const ai_float t_in_0_fmt_scale_const_f32 = 0.07013958692550659f;
    const ai_float t_out_0_fmt_scale_const_f32 = 0.03830137848854065f;
  ...
  /* LITE_KERNEL_SECTION BEGIN conv2d_9 */
  {
    ...
    const ai_i8 t_in_0_fmt_zero_const_s8 = -128;
    const ai_i8 t_out_0_fmt_zero_const_s8 = -128;
    const ai_float t_in_0_fmt_scale_const_f32 = 0.03830137848854065f;
    const ai_float t_out_0_fmt_scale_const_f32 = 0.061668142676353455f;
  ...
  /* LITE_KERNEL_SECTION BEGIN conv2d_10 */
  {
    ...
    const ai_i8 t_in_0_fmt_zero_const_s8 = -128;
    const ai_i8 t_out_0_fmt_zero_const_s8 = -128;
    const ai_float t_in_0_fmt_scale_const_f32 = 0.061668142676353455f;
    const ai_float t_out_0_fmt_scale_const_f32 = 0.03443523123860359f;
  ...
  /* LITE_KERNEL_SECTION BEGIN gemm_12 */
  {
    ...
    const ai_float t_in_0_fmt_scale_const_f32 = 0.008963529951870441f;
    const ai_float t_out_0_fmt_scale_const_f32 = 0.10938860476016998f;
    const ai_float t_weight_0_fmt_scale_const_f32 = 0.009827172383666039f;
  ...
  forward_lite_nl_softmax_is8os8(t_out_0_ptr_s8, t_in_0_ptr_const_s8, t_in_0_shape_ch_prod_const_u32, 1, 10, 1879281920, 23, -248, t_scratch_0_ptr_s32);
