...
const stai_network_details g_network_details = {
  .tensors = (const stai_tensor[21]) {
   ...
   { .size_bytes = 108800, .flags = (STAI_FLAG_HAS_BATCH|STAI_FLAG_CHANNEL_FIRST), .format = STAI_FORMAT_S8, .shape = {4, (const int32_t[4]){1, 64, 48, 32}}, .scale = {1, (const float[1]){0.06574312597513199}}, .zeropoint = {1, (const int16_t[1]){-128}}, .name = "conv2d_2_output" },
   { .size_bytes = 108800, .flags = (STAI_FLAG_HAS_BATCH|STAI_FLAG_CHANNEL_FIRST), .format = STAI_FORMAT_S8, .shape = {4, (const int32_t[4]){1, 64, 50, 34}}, .scale = {1, (const float[1]){0.06574312597513199}}, .zeropoint = {1, (const int16_t[1]){-128}}, .name = "conv2d_3_pad_before_output" },
   ...
   { .size_bytes = 59904, .flags = (STAI_FLAG_HAS_BATCH|STAI_FLAG_CHANNEL_FIRST), .format = STAI_FORMAT_S8, .shape = {4, (const int32_t[4]){1, 128, 24, 16}}, .scale = {1, (const float[1]){0.04955274611711502}}, .zeropoint = {1, (const int16_t[1]){-128}}, .name = "conv2d_4_output" },
   { .size_bytes = 59904, .flags = (STAI_FLAG_HAS_BATCH|STAI_FLAG_CHANNEL_FIRST), .format = STAI_FORMAT_S8, .shape = {4, (const int32_t[4]){1, 128, 26, 18}}, .scale = {1, (const float[1]){0.04955274611711502}}, .zeropoint = {1, (const int16_t[1]){-128}}, .name = "conv2d_5_pad_before_output" },
   ...
   { .size_bytes = 59904, .flags = (STAI_FLAG_HAS_BATCH|STAI_FLAG_CHANNEL_FIRST), .format = STAI_FORMAT_S8, .shape = {4, (const int32_t[4]){1, 128, 24, 16}}, .scale = {1, (const float[1]){0.04988973215222359}}, .zeropoint = {1, (const int16_t[1]){-128}}, .name = "conv2d_6_output" },
   { .size_bytes = 59904, .flags = (STAI_FLAG_HAS_BATCH|STAI_FLAG_CHANNEL_FIRST), .format = STAI_FORMAT_S8, .shape = {4, (const int32_t[4]){1, 128, 26, 18}}, .scale = {1, (const float[1]){0.04988973215222359}}, .zeropoint = {1, (const int16_t[1]){-128}}, .name = "conv2d_7_pad_before_output" },
   ...
   { .size_bytes = 35840, .flags = (STAI_FLAG_HAS_BATCH|STAI_FLAG_CHANNEL_FIRST), .format = STAI_FORMAT_S8, .shape = {4, (const int32_t[4]){1, 256, 12, 8}}, .scale = {1, (const float[1]){0.03830137848854065}}, .zeropoint = {1, (const int16_t[1]){-128}}, .name = "conv2d_8_output" },
   { .size_bytes = 35840, .flags = (STAI_FLAG_HAS_BATCH|STAI_FLAG_CHANNEL_FIRST), .format = STAI_FORMAT_S8, .shape = {4, (const int32_t[4]){1, 256, 14, 10}}, .scale = {1, (const float[1]){0.03830137848854065}}, .zeropoint = {1, (const int16_t[1]){-128}}, .name = "conv2d_9_pad_before_output" },
