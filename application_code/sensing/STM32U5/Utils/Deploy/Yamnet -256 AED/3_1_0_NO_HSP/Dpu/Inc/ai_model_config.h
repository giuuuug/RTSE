...
#define CTRL_X_CUBE_AI_MODEL_CLASS_LIST          {"chainsaw","clock_tick","crackling_fire","crying_baby","dog","helicopter","rain","rooster","sea_waves","sneezing"}
...
#define CTRL_X_CUBE_AI_SPECTROGRAM_SILENCE_THR   (3000) // 0 means disabled
