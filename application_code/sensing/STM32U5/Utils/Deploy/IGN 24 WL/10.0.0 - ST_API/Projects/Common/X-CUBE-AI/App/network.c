...
/*****************************************************************************/
#define _STAI_NETWORK_MODEL_SIGNATURE     "0x20541b0ee0cac8df427950c53fad9e78"
#define _STAI_NETWORK_DATETIME            "2025-03-06T15:31:10+0100"
  ...
  const stai_run_mode mode)
{
  ...
  /* LITE_KERNEL_SECTION BEGIN conv2d */
  {
    ...
    ai_float* t_out_0_ptr_f32 = (ai_float*)(net_ctx->_activations[0] + 352);
    ...
    ai_float* t_scratch_0_ptr_f32 = (ai_float*)(net_ctx->_activations[0] + 288);
  ...
  {
      ai_handle t_out_0_ptr_handle = (ai_handle)(net_ctx->_activations[0] + 352);
    const ai_handle t_in_0_ptr_const_handle = (ai_handle)(net_ctx->_activations[0] + 352);
