...
- evaluate:
    - To evaluate a model, quantized or not (.tflite or QDQ onnx)
- Chain_eqe:
...
Here is an example where we evaluate an ONNX model before quantizing it, evaluate it again for comparison and benchmark it on a STM32N6570-DK.
...
You can look at user_config.yaml example [here](../../config_file_examples) for other operation modes.
