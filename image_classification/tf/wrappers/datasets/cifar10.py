...
from image_classification.tf.src.datasets.cifar10 import load_cifar10
from image_classification.tf.src.datasets import prepare_kwargs_for_dataloader

__all__ = ['get_cifar10']

@DATASET_WRAPPER_REGISTRY.register(framework='tf', dataset_name='cifar10', use_case="image_classification")
def get_cifar10(cfg):

    """
    Loads the images from cifar10 dataset, pre-process them and return training, validation, and test tf.data.Datasets.
    ...
    # Creates datasets
    dataloaders = load_cifar10(training_path=args['training_path'],
