...
from image_classification.tf.src.datasets.utils import preprocess_data
...
@DATASET_WRAPPER_REGISTRY.register(framework='tf', dataset_name='imagenet', use_case="image_classification")
