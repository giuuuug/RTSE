...
@DATASET_WRAPPER_REGISTRY.register(framework='tf', dataset_name='food101', use_case="image_classification")
def get_food101(cfg): 

    """
    Loads the images from the food101 dataset, pre-process them and return training, validation, and test tf.data.Datasets.
    ...
    if args['data_dir'] and args['training_path'] == None and\
        ...
        args['training_path'], args['validation_path'] = download_dataset(data_root=args['data_dir'],
