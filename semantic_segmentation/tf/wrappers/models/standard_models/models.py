...
TF_MODEL_FNS = {"deeplabv3_mnv2_a050_s16_asppv1": (get_deeplabv3, {
    'backbone': 'mobilenet', 'version': 'v2', 'alpha': 0.50, 'output_stride': 16, 'aspp_version': 'v1'}),
    "st_deeplabv3_rn50v1_s16_asppv1": (get_deeplabv3, {
    'backbone': 'resnet50', 'version': 'v1', 'output_stride': 16, 'aspp_version': 'v1'}),}
...
def register_tf_model_wrapper(model_fn, model_name, **model_init_kwargs):
    ...
    def build_model_fn(cfg):
        ...
        merged_model_kwargs = {**filtered_kwargs, **model_init_kwargs}
