...
def get_custom_model(input_shape: tuple[int] = (24, 3, 1),
                    ...
                    **kwargs):
    '''
    builds and return a custom Keras model for Human Activity Recognition
    Args:
        input_shape (tuple[int]): shape of the input data (default: (24, 3, 1))
    ...
    Returns:
        model (keras.Model): the constructed Keras model
    '''
