...
from pose_estimation.tf.src.models import *



POSE_ESTIMATION_MODEL_FNS = {
    'custom_models': (get_custom_model, {}),
    'st_movenet_lightning_a100_heatmaps': (get_st_movenet_lightning_heatmaps, {"alpha":1}),
    'st_movenet_lightning_heatmaps': (get_st_movenet_lightning_heatmaps, {}),
}
...
for _model_name, (_model_fn, _model_kwargs) in POSE_ESTIMATION_MODEL_FNS.items():
